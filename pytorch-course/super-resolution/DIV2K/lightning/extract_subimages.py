...
def main():
    ...
    # HR images
    opt['input_folder'] = '../datasets/DIV2K_train_HR'
    opt['save_folder'] = '../datasets/DIV2K_train_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = '../datasets/DIV2K_train_LR_mild'
    opt['save_folder'] = '../datasets/DIV2K_train_LR_mild_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
...
def worker(path, opt):
    ...
    img_name = img_name.replace('x2', '').replace('x3', '').replace('x4m', '').replace('x8', '')
